'''
Basically what this do is collecting similar faces from a bunch of photos,
and then output the most appeared faces in the output folder
'''
import sys
import os
import dlib
...
if (len(sys.argv) != 5):
    print(
        ...
        "   .\\face_clustering.py shape_predictor_5_face_landmarks.dat dlib_face_recognation_resnet_model_v1.dat ..\\example\\faces output_folder \n"
